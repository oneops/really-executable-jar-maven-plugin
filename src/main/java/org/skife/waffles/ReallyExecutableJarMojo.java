...
public class ReallyExecutableJarMojo extends AbstractMojo {
  ...
  /**
   * Specifies the classifier of the input artifact 
   */
  @Parameter(property = "really-executable-jar.classifier")
  private String classifier;

  /**
   * Specifies the classifier of the output artifact
   */
  @Parameter(property = "really-executable-jar.classifier")
  private String outputClassifier = "executable";
  ...
  public void execute() throws MojoExecutionException {
    ...
    try {
      ...
      if (outputClassifier != null) {
        ...
        name = name.substring(0,name.lastIndexOf('-') + 1) + outputClassifier + ".jar";
        File exec = new File(dir, name);
        FileUtils.copyFile(file, exec);
        makeExecutable(exec);
        projectHelper.attachArtifact(project, exec, outputClassifier);
      } else {
        makeExecutable(file);
      }
    } catch (IOException e) {
